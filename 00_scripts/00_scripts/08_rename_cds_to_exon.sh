...
apptainer exec /project/sheynkman/dockers/LRP/pb-cds-gtf_latest.sif /bin/bash -c " \
  ...
  --sample1_gtf 07_make_cds_gtf/Q157R_cds.gtf \
  --sample1_name 08_rename_cds_to_exon/Q157R \
  --sample2_gtf 07_make_cds_gtf/WT_cds.gtf \
  --sample2_name 08_rename_cds_to_exon/WT \
