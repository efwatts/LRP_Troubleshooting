...
def main():
    ...
    parser.add_argument("--day", action="store", dest="day", required=True, choices=['condition1', 'condition2'], help="Specify the day for color coding")
    ...
    MAJOR_COLORS = {"condition1": "#E99787", "condition2": "#336B87"}
    MINOR_COLORS = {"condition1": "#EED8C9", "condition2": "#90AFC5"}
