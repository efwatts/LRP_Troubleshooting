...
###############################################
```{r read-gene-data}
counts_gene <- read_delim("/Volumes/sheynkman/projects/LRP_Mohi_project/19_LRP_summary/gene_level_counts.txt", 
...
write.table(design, "edgeR/design_matrix_gene.txt", sep = "\t", quote = FALSE, row.names = TRUE, col.names = NA)
...
png("edgeR/QLDisp_plot_gene.png", width = 800, height = 600)
plotQLDisp(fit)
dev.off()
