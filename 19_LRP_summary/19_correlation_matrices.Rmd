...
obj <- load("edgeR/edgeR_gene/dge_raw.rda")   # loads one object, usually named 'dge'
dge_raw <- get(obj)

obj <- load("edgeR/edgeR_gene/dge_norm.rda")
dge_norm <- get(obj)

# Transcript-level edgeR objects
obj <- load("edgeR/edgeR_transcript/dte_raw.rda")
dte_raw <- get(obj)

obj <- load("edgeR/edgeR_transcript/dte_norm.rda")
dte_norm <- get(obj)
