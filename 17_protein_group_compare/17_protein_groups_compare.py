...
def determine_source_database_for_grps(unassigned_grps):
    ...
    for grp in unassigned_grps:
        if grp_is_derived_from_pacbio(grp):
            grps.append('PacBio') #grps.concat(['PacBio':grp])
        elif grp_is_derived_from_gencode(grp):
            grps.append('GENCODE') #grps.concat(['GENCODE':grp])
        else:
            grps.append('UniProt') #grps.concat(['UniProt':grp])
...
def accession_compare(df1,df2,db1_id, db2_id, output):
        ...
        for group2 in list_set_db2:
            if len(group1.intersection(group2))>0:
                ...
                if len(group1.intersection(group2)) == len(group1.union(group2)):
                    ...
                    Exactly_one_match = pd.concat([Exactly_one_match, pd.DataFrame([[data1.iat[0, 0], data1.iat[0,1], data1.iat[0, 2], data1.iat[0, 3], data1.iat[0, 4], data1.iat[0, 5], data1.iat[0, 6], data1.iat[0, 7],data2.iat[0, 0], data2.iat[0,1], data2.iat[0, 2], data2.iat[0, 3], data2.iat[0, 4], data2.iat[0, 5], data2.iat[0, 6], data2.iat[0, 7]]], columns=cols)])
                    ...
                    data1 = df1.loc[df1['Protein Accession Translation {}'.format(db1_id)] == group1]
                    data2 = df2.loc[df2['Protein Accession Translation {}'.format(db2_id)] == group2]
                    Simpler_in_one = pd.concat([Simpler_in_one, pd.DataFrame([[data1.iat[0, 0], data1.iat[0,1], data1.iat[0, 2], data1.iat[0, 3], data1.iat[0, 4], data1.iat[0, 5], data1.iat[0, 6], data1.iat[0, 7],data2.iat[0, 0], data2.iat[0,1], data2.iat[0, 2], data2.iat[0, 3], data2.iat[0, 4], data2.iat[0, 5], data2.iat[0, 6], data2.iat[0, 7]]], columns=cols)])
                    list_set_db2_matches.append(group2)                    
                    break
                    ...
                    data1 = df1.loc[df1['Protein Accession Translation {}'.format(db1_id)] == group1]
                    data2 = df2.loc[df2['Protein Accession Translation {}'.format(db2_id)] == group2]
                    Simpler_in_two = pd.concat([Simpler_in_two, pd.DataFrame([[data1.iat[0, 0], data1.iat[0,1], data1.iat[0, 2], data1.iat[0, 3], data1.iat[0, 4], data1.iat[0, 5], data1.iat[0, 6], data1.iat[0, 7],data2.iat[0, 0], data2.iat[0,1], data2.iat[0, 2], data2.iat[0, 3], data2.iat[0, 4], data2.iat[0, 5], data2.iat[0, 6], data2.iat[0, 7]]], columns=cols)])
                    list_set_db2_matches.append(group2)                    
                else:
                    # overlap
                    data1 = df1.loc[df1['Protein Accession Translation {}'.format(db1_id)] == group1]
                    data2 = df2.loc[df2['Protein Accession Translation {}'.format(db2_id)] == group2]
                    Partially_overlapping = pd.concat([Partially_overlapping, pd.DataFrame([[data1.iat[0, 0], data1.iat[0,1], data1.iat[0, 2], data1.iat[0, 3], data1.iat[0, 4], data1.iat[0, 5], data1.iat[0, 6], data1.iat[0, 7],data2.iat[0, 0], data2.iat[0,1], data2.iat[0, 2], data2.iat[0, 3], data2.iat[0, 4], data2.iat[0, 5], data2.iat[0, 6], data2.iat[0, 7]]], columns=cols)])
                    list_set_db2_matches.append(group2)                    
        if distinct == True:
            #completely distinct
            data1 = df1.loc[df1['Protein Accession Translation {}'.format(db1_id)] == group1]                   
            No_shared_accessions_db1 = pd.concat([No_shared_accessions_db1, data1])            
    ...
    for group in list_set_unique_db2:                    
        ...
        No_shared_accessions_db2=pd.concat([No_shared_accessions_db2, data])
